      ...
      .then((json) => {
        const result = json.filter((products) => {
          return (
            products &&
            products.name &&
            products.name.toUpperCase().includes(value)
          );
        });
        console.log(result);
      });
    ...
    <nav className="navbar-container">
      <div className="flex bg-slate-100">
        <div className="container flex">
          ...
          <div className="items-center flex mt-3 ml-32">
            <input
          ...
          {user ? (
            ...
            <>
              <div className="flex mr-20 ">
                <div className="flex mr-40 mt-14">
                ...
                <a className="ml-5 w-11 float-right mt-6 text-red-600" href="">
                  Bạn Cần giúp đỡ?
                </a>
              </div>
            </>
